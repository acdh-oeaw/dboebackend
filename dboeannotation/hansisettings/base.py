...
def generate_secret_key(length=50):
    ...
    return "".join(
        [sample[unpack(">I", os.urandom(4))[0] % len(sample)] for i in range(length)]
    )
...
env = Env(
    ...
    DJANGO_ALLOWED_HOSTS=(
        ...
        re.sub(
            ...
            "",
            os.environ.get(
                "GITLAB_ENVIRONMENT_URL", "http://127.0.0.1,http://localhost"
            ),
        ).split(","),
    ),
    ...
    DJANGO_CORS_ORIGIN_WHITELIST=(
        tuple,
        ("127.0.0.1", "127.0.0.1:8080", "localhost:8000", "localhost:8080"),
    ),
